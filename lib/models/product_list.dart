...
import 'package:simpleshopflutter/models/product.dart';




class ProductList with ChangeNotifier{
  final _baseUrl = 'https://shop-playyy-default-rtdb.firebaseio.com/produtos';
  ...
  Future<void> removeProduct(Product product) async{
    ...
    if(index >= 0){
      ...
      if(response.statusCode >= 400){
        ...
        notifyListeners();
        throw HttpException(msg: 'Não foi possível executar a ação.', statusCode: response.statusCode);
      }
    }
  }
